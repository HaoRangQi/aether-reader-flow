...
读一本《钱从哪里来》这样的金融科普书，平均每 10 分钟就会遇到一个不熟悉的概念（M2、SLF、逆回购、通胀传导……）、一个未经验证的观点、一段需要查证的引用。传统应对方式（百度跳出阅读流、问朋友、放过去算了）都在打断**心流**。
...
用户读 *The Intelligent Investor* 英文版：
1. 上传 PDF
2. 遇到 "margin of safety" → 划词 → 中文翻译 + 投资术语解释
3. 看到 Graham 对成长股的论述 → 觉得逻辑可疑 → 划词 → "请验证此观点的现代有效性" → AI 引用近 20 年学术研究反馈
4. 同样产生时间轴日志、可导出
